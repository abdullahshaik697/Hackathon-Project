...
const Adminlogin = () =>{
    ...
    const adminEmail = "admin1234@admin.com"
    ...
    return(
        ...
        <div className="flex min-h-full mt-6 flex-col justify-center px-6 py-12 lg:px-8 mx-80 ">
          ...
          <div  className="space-y-6">
            ...
            <div>
              ...
              <div className="mt-2">
                <input
                  ...
                  required
                  className="block w-full border-2 rounded-md bg-white px-3 py-1.5 text-base text-gray-900 placeholder:text-gray-400 sm:text-sm/6"
                />
              </div>
            </div>
            ...
            <div>
              <button
                ...
                className="flex w-full justify-center rounded-md bg-green-600 px-3 py-1.5 text-sm/6 font-semibold text-white shadow-xs hover:bg-green-800 "
              >
                Sign in
              </button>
            </div>
